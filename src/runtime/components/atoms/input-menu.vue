      ...
      >
        <div>
          <div
            v-if="popper.arrow"
            data-popper-arrow
            :class="Object.values(uiMenu.arrow)"
          />
...
import { input, inputMenu } from "#mei-ui/ui-configs";
...
const configMenu = mergeConfig<typeof inputMenu>(
  appConfig.meiUI.strategy,
  appConfig.meiUI.inputMenu,
  inputMenu
);
...
export default defineComponent({
  ...
  setup(props, { emit, slots }) {
    ...
    const debouncedSearch =
      props.search && typeof props.search === "function"
        ? useDebounceFn(props.search, props.debounce)
        : undefined;
